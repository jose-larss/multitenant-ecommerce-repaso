...
import { ProductListSubcategorySkeleton, ProductsListSubcategory } from "../ui/components/products-list-subcategory";
...
export const ProductListViewSubcategory = ({category, subcategory}: Props) => {
    return(
        <div className="p-4 lg:px-12 py-8 flex flex-col gap-4">  
            ...
            <div className="grid grid-cols-1 lg:grid-cols-6 xl:grid-cols-8 gap-y-6 gap-x-12">
                ...
                <div className="lg:col-span-4 xl:col-span-6">
                    <Suspense fallback={<ProductListSubcategorySkeleton/>}>
